...
from yolo.utils import DEFAULT_CFG, LOGGER, RANK, SETTINGS, TQDM_BAR_FORMAT, callbacks, emojis
...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            model = DetectMultiBackend(model, device=self.device, dnn=self.args.dnn, fp16=self.args.half)
            self.model = model
