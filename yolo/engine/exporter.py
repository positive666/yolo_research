...
from models.yolo import V8_Detect, V8_Segment, ClassificationModel, DetectionModel, SegmentationModel,guess_model_task
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        self.args.batch = 1
        self.imgsz = check_img_size(self.args.imgsz, stride=model.stride, min_dim=2)  # check image size
        ...
        for k, m in model.named_modules():
            if isinstance(m, (V8_Detect, V8_Segment)):
