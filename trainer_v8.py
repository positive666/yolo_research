...
from val_v8 import DetectionValidator
from utils.data.build import build_dataloader
from engine.trainer import BaseTrainer
from utils.cfg import DEFAULT_CFG
from utils.loss import BboxLoss
from utils.ops import xywh2xyxy
from utils.plots import plot_images_masks as plot_images, plot_results
...
class DetectionTrainer(BaseTrainer):
    ...
    def preprocess_batch(self, batch):
        #print("preprocess_batch:",type(batch))
...
class Loss:
    ...
    def __call__(self, preds, batch):
       ...
       # print('batchboxese:',batch["bboxes"].shape)
       # print("xxx:",targets.shape)
