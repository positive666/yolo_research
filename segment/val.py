...
Usage - formats:
    $ python segment/val.py --weights yolov5s-seg.pt                 # PyTorch
                                      ...
                                      yolov5s-seg.cls_openvino_model # OpenVINO
...
def run(
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path('../datasets/coco/annotations/instances_val2017.json'))  # annotations json
...
def main(opt):
    ...
    if opt.task in ('train', 'val', 'test'):  # run normally
        ...
        opt.half = torch.cuda.is_available() and opt.device != 'cpu'  # FP16 for fastest results  # FP16 for fastest results
